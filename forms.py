...
('marketing', 'Marketing'), ('sales', 'Sales'), ('product', 'Product'), ('business', 'Business'), ('data', 'Data'), ('devops', 'DevOps'), ('finance-legal', 'Finance/Legal'), ('hr', 'Human Resources'), ('qa', 'Q/A'), ('teaching', 'Teaching'), ('writing', 'Writing'), ('medical-health', 'Medical/Health'), ('all-others', 'All Others')], key=lambda x: x[1])
