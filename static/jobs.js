...
$(async function(){
    ...
    async function getSavedJobs(){
        const res = await axios.get(`/saved-jobs/${userId}`);
    ...
    $(".star").click(async function(e){
        ...
        async function saveJob($jobId, userId, $jobTitle){
            const res = await axios.post(`/saved-jobs`, {saved_job_id: $jobId, user_id: userId, job_title: $jobTitle, company_name: companyName, job_url: jobUrl});
